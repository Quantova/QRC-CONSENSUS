...
//! SHAKE256 from the crypto crate, a post quantum hash, so the sampler is hash
//! based and seeded from the previous block beacon as the specification states.
...
/// with a lower score is preferred, and the seed comes from the beacon.
