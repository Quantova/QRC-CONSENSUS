...
/// tree. The secret is high entropy material the validator alone holds; the tree
/// seed follows from it by a domain separated SHAKE and is never published. Only
/// the resulting Merkle root is a commitment, and the root reveals neither this
/// seed nor the secret.
