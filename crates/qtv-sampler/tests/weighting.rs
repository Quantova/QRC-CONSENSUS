...
fn selection_frequency_matches_the_stake_share() {
    ...
    let low = frequency(1_000, 4_000, 1, 0x1111);
    let high = frequency(3_000, 4_000, 1, 0x2222);
...
fn frequency_is_proportional_to_stake() {
    ...
    let total = 10;
    let budget = 2;
    let f1 = frequency(1, total, budget, 0xA1);
    let f2 = frequency(2, total, budget, 0xA2);
    let f3 = frequency(3, total, budget, 0xA3);
    let f4 = frequency(4, total, budget, 0xA4);
